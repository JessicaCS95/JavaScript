...
//para corrigir o retorno dos filhos do nó, sem os espaços em branco no texto
...
//console.log(document.body.children[2].children[1].textContent);
...
// Criando um nó de texto para a nova lista
li.textContent = "Blog";
...
// Inserindo o h3 abaixo do H1 
const h1NovoTitulo = document.querySelector("h1");
h1NovoTitulo.insertAdjacentElement("afterend", h3); 
...
//HTML Collection
//fazendo um loop li e alterando a cor de fundo
